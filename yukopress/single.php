...
<h2 class="header__pageTitle"><?php single_post_title(); ?></h2>
    ...
    <nav class="gnavi">
        <ul class="gnavi__list flex">
            ...
            <li class="gnavi__item current"><a href="<?php echo esc_url(home_url('/blog/')); ?>">Blog</a></li>
...
<?php the_post(); // データ１件分を取り出して渡す ?>
    <!-- Blog -->
    <section class="main__box single">
        <div class="single__wrapper">
            <time class="single__time"><?php the_time('Y年n月j日'); ?></time>
            <h4 class="blog__textTitle"><?php the_title(); ?></h4>
            <?php the_category('&nbsp;'); ?>

            <img src="img/no-image.jpg" alt="" class="single__img">
